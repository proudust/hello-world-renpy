...
define config.name = _("HelloWorldRenPy")
...
## About（バージョン情報）スクリーンに表示されるテキスト。パラグラフ間に空白の行
## を挿入したい場合は、\n\n と書いてください。
...
define build.name = "HelloWorldRenPy"
...
define config.save_directory = "HelloWorldRenPy-1562635995"
